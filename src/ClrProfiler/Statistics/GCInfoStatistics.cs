...
public readonly struct GCInfoStatistics(DateTime date, GCMode gCMode, GCLargeObjectHeapCompactionMode compactionMode, GCLatencyMode latencyMode, long heapSize, long totalAllocationSize, int gen0Count, int gen1Count, int gen2Count, int timeInGc, ulong gen0Size, ulong gen1Size, ulong gen2Size, ulong lohSize) : IEquatable<GCInfoStatistics>
{
    ...
    public readonly GCLargeObjectHeapCompactionMode CompactionMode = compactionMode;
    /// <summary>
    /// <strong>Batch</strong>
    ...
    /// </summary>
    public readonly GCLatencyMode LatencyMode = latencyMode;
    public readonly long HeapSize = heapSize;
    public readonly long TotalAllocationBytes = totalAllocationSize;
    public readonly int Gen0Count = gen0Count;
    public readonly int Gen1Count = gen1Count;
    public readonly int Gen2Count = gen2Count;
    /// <summary>
    /// Percent
    /// </summary>
    public readonly int TimeInGc = timeInGc;
    /// <summary>
    /// bytes
    /// </summary>
